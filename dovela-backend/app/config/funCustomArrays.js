...
// 1.1 CAN BE MULTIPLE
exports._FUN_1_PARSER = (_ARRAY, noLetters) => {
    if (!_ARRAY) return ""
...
exports._FUN_2_PARSER = (_ARRAY, noLetters) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
...
exports._FUN_3_PARSER = (_ARRAY, noLetters) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalStr = _defaultValue;
    for (var i = 0; i < _defaultValue.length; i++) {
...
exports._FUN_4_PARSER = (_ARRAY, noLetters) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalStr = _defaultValue;
    for (var i = 0; i < _defaultValue.length; i++) {
...
exports._FUN_5_PARSER = (_ARRAY, noLetters) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalArray = []
    var _finalStr = ""
...
exports._FUN_6_PARSER = (_ARRAY, useSimplyfy) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalArray = []
    var flag = false;
...
exports._FUN_8_PARSER = (_ARRAY, noLetters) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalStr = _defaultValue;
    for (var i = 0; i < _defaultValue.length; i++) {
...
exports._FUN_101_PARSER = (_ARRAY) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalStr = _defaultValue;
    for (var i = 0; i < _defaultValue.length; i++) {
...
exports._FUN_102_PARSER = (_ARRAY) => {
    if (!_ARRAY) return ""
    var _defaultValue = _ARRAY
    var _finalStr = _defaultValue;
    for (var i = 0; i < _defaultValue.length; i++) {
...
exports._FUN_24_PARSER = (_ARRAY, noLetters) => {
