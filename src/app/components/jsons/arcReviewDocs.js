...
export const REVIEW_DOCS_FL2 = [
   {
        ...
        items: [
            ...
            { v: 3, c: 3, rtype: ['con', 'sub', 'cer', 'ph', 'col',], className: 'text-primary', name: 'Número de matricula del arquitecto', },
            { v: 4, c: 4, rtype: ['con', 'sub', 'cer', 'ph', 'col',], className: 'text-primary', name: 'Escala', },
            { v: 5, c: 5, rtype: ['sub', 'col',], name: 'OBSERVACIÓN GENERAL ', },
            { v: 6, c: 6, rtype: ['con', 'sub', 'cer', 'ph', 'col',], name: 'Código Catastral /matricula inmobiliaria', },
            { v: 7, c: 7, rtype: ['con', 'sub', 'cer', 'ph', 'col',], name: 'Propietario', },
            { v: 8, c: 8, rtype: ['con', 'sub', 'cer', 'ph', 'col',], name: 'Tipo de tramite', },
            { v: 9, c: 9, rtype: ['con', 'sub', 'cer', 'ph', 'col',], name: 'Contenido del Plano', },
            { v: 10, c: 10, rtype: ['con', 'sub', 'cer', 'ph', 'col',], name: 'Numeración del plano', },
            { v: 11, c: 11, rtype: ['con', 'sub', 'cer', 'ph', 'col',], name: 'Fecha', },
        ]
    },
    {
        v: 0, c: 0, pid: 'rar_2', rtype: ['con', 'sub', 'cer', 'ph', 'col',], title: 'Características del predio ',
