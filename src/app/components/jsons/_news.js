        ...
        noticia:
            <div className='container'>
                <div className="row align-items-center py-1">
                    <div className="col-12 px-4 border border-info py-4 m-3" style={{ backgroundColor: ' #f9f9f9 ', borderRadius: '2px', border: '1px' }}>
                            ...
                            <div className='container'>
                                <div className="row justify-content-start">
                                    ...
                                    <div className="col-lg-2">
                                        <img src={REPARTO} className="d-block w-100 mt-1" alt="..." />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-12 px-4 border border-info py-4 m-3" style={{ backgroundColor: ' #f9f9f9 ', borderRadius: '2px', border: '1px' }}>
                        <div className="px-4 py-1">
                            ...
                            <div className='container'>
                                <div className="row justify-content-start">
                                    <div className="col-3">
                                        <img src={NEW_3_ING} className="d-block w-100 mt-1" alt="..." />
                                    </div>
                                    <div className="col-8">
                        ...
                        <div className="px-4 py-1">
                            ...
                            <div className='container'>
                                <div className="row justify-content-start">
                                    ...
                                    <div className="col-4">
                                        <img src={NEW_2_ING} className="d-block w-100 mt-1" alt="..." />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-12 px-4 border border-info py-4 m-3" style={{ backgroundColor: ' #f9f9f9 ', borderRadius: '2px', border: '1px' }}>
                        <div className="px-4 py-1">
                            ...
                            <div className='container'>
                                <div className="row justify-content-start">
                                    <div className="col-3">
                                        <img src={NEW_ING} className="d-block w-100 mt-1" alt="..." />
                                    </div>
                                    <div className="col-8">
