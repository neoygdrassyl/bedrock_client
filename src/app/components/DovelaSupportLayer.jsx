...
const TUTORIAL_STEPS = [
  {
    ...
    bullets: ['Resumen personal', 'Búsqueda superior', 'Ruta de regreso al panel'],
    target: '[data-dovela-tour-id="dashboard-hero"]',
    focusLabel: 'Encabezado del dashboard',
  },
  {
    icon: 'BriefcaseBusiness',
    title: 'Módulos agrupados',
    body: 'El tablero reúne los accesos en seis frentes grandes para llegar al flujo correcto sin depender de atajos sueltos.',
    bullets: ['Radicación', 'Gestión Curaduría', 'Archivo y Expedición'],
    target: '[data-dovela-tour-id="dashboard-operations"]',
    focusLabel: 'Módulos agrupados',
  },
  {
    icon: 'Bookmark',
