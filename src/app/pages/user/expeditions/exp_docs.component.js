...
function EXP_DOCS({ translation, swaMsg, globals, currentItem, currentVersion, currentRecord, currentVersionR, recordArc, requestUpdate, requestUpdateRecord }) {
    ...
    const [activePaymentSection, setActivePaymentSection] = useState(null);
    ...
    useEffect(() => {
        ...
        const isPaymentSectionOpen = (sectionId) => activePaymentSection === sectionId;
        const togglePaymentSection = (sectionId) => {
            setActivePaymentSection((currentSection) => currentSection === sectionId ? null : sectionId);
        };
    ...
    return (
        ...
        return (
            ...
            {_GLOBAL_ID === 'cp1' ?
                <Collapsible className='bg-light border border-info text-center my-1' openedClassName='my-1 bg-light border border-info text-center' trigger={<><label className="fw-normal text-info text-center">Liquidación de Expensas</label></>}>
                    <form id="form_expedition_4" onSubmit={pdf_gen_7}>
                        {_COMPONENT_DOC_7()}
                        <div className="row text-center">
                            <div className="col">
            ...
            {!conOA() && _GLOBAL_ID === 'cb1' || _GLOBAL_ID === 'fl2' ? <>
                <Collapsible className='bg-light border border-info text-center my-1' openedClassName='my-1 bg-light border border-info text-center' trigger={<><label className="fw-normal text-info text-center">Liquidacion de Expensas</label></>}>
                    <form id="form_expedition_2" onSubmit={pdf_gen_2}>
                        {_COMPONENT_DOC_2()}
                        <div className="row text-center">
                            <div className="col">
            ...
            {!conOA() && _GLOBAL_ID === 'cb1' ? <>
                <Collapsible className='bg-light border border-info text-center my-1' openedClassName='my-1 bg-light border border-info text-center' trigger={<><label className="fw-normal text-info text-center">Impuestos Municipales</label></>}>
                    <form id="form_expedition_3" onSubmit={pdf_gen_3}>
                        {_COMPONENT_DOC_3()}
                        <div className="row text-center">
                            <div className="col">
            ...
            <Collapsible className='bg-light border border-info text-center my-1' openedClassName='my-1 bg-light border border-info text-center' trigger={<><label className="fw-normal text-info text-center">Estampilla PRO-UIS</label></>}>
                <form id="form_expedition_4" onSubmit={pdf_gen_4}>
                    {_COMPONENT_DOC_4()}
                    <div className="row text-center">
                        <div className="col">
            ...
            {_GET_CHILD_2().item_267 > 2 && _GLOBAL_ID === 'cb1' ?
                <Collapsible className='bg-light border border-info text-center my-1' openedClassName='my-1 bg-light border border-info text-center' trigger={<><label className="fw-normal text-info text-center">Deberes Urbanisticos - Estrato: {_GET_CHILD_2().item_267 ?? <label className="fw-bold text-danger">SIN DEFINIR</label>}</label></>}>
                    <form id="form_expedition_4" onSubmit={pdf_gen_5}>
                        {_COMPONENT_DOC_5()}
                        <div className="row text-center">
                            <div className="col">
            ...
            {_GLOBAL_ID === 'cp1' || _GLOBAL_ID === 'fl2' ?
                <Collapsible className='bg-light border border-info text-center my-1' openedClassName='my-1 bg-light border border-info text-center' trigger={<><label className="fw-normal text-info text-center">Impuesto Delineación Urbana</label></>}>
                    <form id="form_expedition_4" onSubmit={pdf_gen_6}>
                        {_COMPONENT_DOC_6()}
                        <div className="row text-center">
                            <div className="col">
