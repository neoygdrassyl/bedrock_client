...
import { dateParser_dateDiff, dateParser_finalDate, dateParser_timePassed } from '../../../../components/customClasses/typeParse';
...
class CLOCKS_CONTROL extends Component {
    ...
    render() {
        ...
        const clocks = [
            ...
            { state: 5, version: false, desc: false, name: 'LEGAL Y DEBIDA FORMA', limit: [3, false, 30], icon: <i class="far fa-check-circle text-success"></i>, },
