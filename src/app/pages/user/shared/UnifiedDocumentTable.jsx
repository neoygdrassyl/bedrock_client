...
function UnifiedDocumentTable({
    ...
    return <div className="space-y-3 rounded-xl border border-border/70 bg-background p-3">
        ...
        {(legalFormLoading || legalFormError || legalSummary.source || legalSummary.totalRequired) ? <div className="space-y-2 rounded-xl border border-border/80 bg-muted/10 p-3">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                <div className="space-y-1">
                    <p className="mb-0 text-sm font-semibold text-foreground">Legal y Debida Forma</p>
                ...
                <div className="flex flex-wrap gap-2">
                    <KpiFilterButton
                        ...
                        title="Filtrar documentos presentes según el endpoint de faltantes"
                    ...
                    <KpiFilterButton
                        ...
                        title="Filtrar documentos faltantes según el endpoint de faltantes"
                    ...
                    <KpiFilterButton
                        ...
                        title="Filtrar documentos pendientes de escaneo según el endpoint de faltantes"
